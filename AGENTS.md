...
- `项目优化计划/` stores staged upgrade documents. Keep numbered Chinese files such as `00-总体升级方案.md`, `01-版本管理方案.md`, `02-第一阶段实施方案.md`, and `03-第二阶段实施方案.md` in sync with delivery progress.
