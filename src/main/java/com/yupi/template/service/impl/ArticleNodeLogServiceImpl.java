...
public class ArticleNodeLogServiceImpl implements ArticleNodeLogService {
    ...
    public void start(String taskId, String phase, String node, String message) {
        ...
        record(taskId, phase, node, NodeExecutionStatusEnum.RUNNING, message, null);
    }

    @Override
    public void success(String taskId, String phase, String node, String message) {
        record(taskId, phase, node, NodeExecutionStatusEnum.SUCCESS, message, resolveElapsedMs(taskId, phase, node, true));
    }

    @Override
    public void fail(String taskId, String phase, String node, String message) {
        record(taskId, phase, node, NodeExecutionStatusEnum.FAILED, message, resolveElapsedMs(taskId, phase, node, true));
    }

    @Override
    public void info(String taskId, String phase, String node, String message) {
        record(taskId, phase, node, NodeExecutionStatusEnum.INFO, message, resolveElapsedMs(taskId, phase, node, false));
    }
